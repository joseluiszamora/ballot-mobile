...
class BallotGobPage extends StatelessWidget {
  BallotGobPage({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: MainAppBarWidget(title: 'VOTACIÓN GOBERNACIÓN'),
        body: Container(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(children: <Widget>[
                          FormBuilder(
                              ...
                              child: Column(children: [
                                listCandidates(
                                    context, Candidate().gobernacionList()),
                                SizedBox(height: 10),
                                FlatButton(
                                    onPressed: () {
